...
public class GetBlobByMetadata  implements java.io.Serializable {
    private com.manheim.webservices.BlobMetaData meta;

    public GetBlobByMetadata() {
    }
    ...
    /**
     * Gets the meta value for this GetBlobByMetadata.
     * 
     * @return meta
     */
    ...
    /**
     * Sets the meta value for this GetBlobByMetadata.
     * 
     * @param meta
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetBlobByMetadata)) return false;
        GetBlobByMetadata other = (GetBlobByMetadata) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetBlobByMetadata.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.manheim.com", ">getBlobByMetadata"));
